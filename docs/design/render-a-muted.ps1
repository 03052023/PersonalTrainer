...
$outDir = Join-Path (Split-Path -Parent $MyInvocation.MyCommand.Path) 'blue-muted'
New-Item -ItemType Directory -Force -Path $outDir | Out-Null

$variants = @(
  @{ key='m1'; label='Azul e terra queimada'; bgTop='#3E5F7E'; bgBot='#2C4763'; center='#E6DFD2'; tipTo='#FFFFFF'; tip=0.07
     petals=@('#7F8A6E','#A0715E','#9C7B63','#8C7187','#7E93A3') },
  @{ key='m2'; label='Mais próximo do fundo'; bgTop='#3E5F7E'; bgBot='#2C4763'; center='#DDD6C8'; tipTo='#FFFFFF'; tip=0.06
     petals=@('#6F7B61','#93654F','#8D6F59','#7D6479','#6F8698') },
  @{ key='m3'; label='Terrosos suaves, um pouco mais claros'; bgTop='#3E5F7E'; bgBot='#2C4763'; center='#EDE7DB'; tipTo='#FFFFFF'; tip=0.06
     petals=@('#939E80','#B4846F','#B08F75','#A08499','#93A6B4') },
  @{ key='m4'; label='Quase monocromático: azuis com marrons'; bgTop='#3E5F7E'; bgBot='#2C4763'; center='#E2DCCF'; tipTo='#FFFFFF'; tip=0.06
     petals=@('#6F8190','#8A6552','#86705E','#7B6A7E','#5E7C96') }
)
