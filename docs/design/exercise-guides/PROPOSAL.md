...
Protótipo nesta pasta (compare.png, compare-dark.png). Gerador: render-exercise-guides.ps1 com exercise-guides.sample.json. Aprovado pelo dono em 2026-09-24.
...
- **Estilo aprovado (v2, "dê mais clareza para o usuário"):** compare-v2.png destaca o que se move, tem seta de movimento, legenda por posição, "Trabalha: …", o supino corrigido e a figura maior. Registrado na SPEC (RF-40, §7.12 E1–E9, decisão 17), no DESIGN §12 e no TASKS.md (T6.1, T6.4–T6.9).
