...
- **Versão 2 (Magister) completa e verde:** M2 + M4 + M5 + identidade. App build final verde no **run 35966481337** (branch `ci/v3-final`, commit b5d5b9b, que é o conteúdo do `main`). O artefato `PersonalTrainer-for-resigning` (IPA só-iPhone para o Impactor) expira em 2026-09-27; depois disso, empurrar o `main` para qualquer `ci/<nome>` gera outro.
...
1. O usuário instala o IPA do run 35966481337 por cima do app atual, pelo Impactor, e testa.
